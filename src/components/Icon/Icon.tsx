...
const iconMap: Record<string, React.ReactNode> = {
  ...
  find_in_page: (
    <path d="M20 19.59V8l-6-6H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2h12c.45 0 .85-.19 1.15-.49l-4.85-4.85c-.28.15-.59.24-.93.24-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5c0 .34-.09.65-.24.93l4.85 4.85zM9 13c0 1.38 1.12 2.5 2.5 2.5S14 14.38 14 13s-1.12-2.5-2.5-2.5S9 11.62 9 13z" fill="currentColor" />
  ),
  ...
  return (
    <svg
      ...
      style={{
        width: iconSize,
        height: iconSize,
        color: color || "var(--bu-fg, rgba(0, 0, 0, 0.87))",
        display: "inline-flex",
        alignItems: "center",
