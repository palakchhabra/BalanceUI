...
import { Card, Badge, List } from "@balanceui/core";
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      ...
      <div className="mb-8 sm:mb-12">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">List</h1>
        ...
        <p className="mt-3 text-base text-gray-600 dark:text-gray-400 sm:mt-4 sm:text-lg">
          List component with avatars, icons, and actions for displaying structured data.
        </p>
      </div>
        ...
        <div className="lg:col-span-2">
          <section className="mb-8 sm:mb-12">
            ...
            <Card variant="elevated" elevation={2} style={{ padding: "1.5rem" }} className="sm:p-8">
              <p className="text-sm text-gray-600 dark:text-gray-400">List component example</p>
            </Card>
          </section>
        </div>
      </div>
