...
import { Card, Badge, TextArea, FormField } from "@balanceui/core";
          ...
          <section className="mb-8 sm:mb-12">
            ...
            <Card variant="elevated" elevation={2} style={{ padding: "1.5rem", marginBottom: "1.5rem" }} className="sm:p-8 sm:mb-8">
              ...
              <div className="space-y-3 sm:space-y-4">
                <TextArea placeholder="Enter your message..." style={{ width: "100%", minHeight: "100px" }} />
                <TextArea
            ...
            <Card variant="elevated" elevation={2} style={{ padding: "1.5rem" }} className="sm:p-8">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <FormField label="Comments" error="This field is required" required>
                  <TextArea placeholder="Enter comments..." style={{ width: "100%", minHeight: "100px" }} />
                </FormField>
              </div>
            </Card>
          </section>
          ...
          <section className="mb-8 sm:mb-12">
            ...
            <div className="overflow-x-auto rounded-lg bg-gray-900 p-4 sm:p-6">
              <pre className="text-xs text-gray-100 sm:text-sm">
                <code>{`import { TextArea, FormField } from '@balanceui/core'
