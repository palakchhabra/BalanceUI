...
import { Card, Badge, Stepper } from "@balanceui/core";
        ...
        <div className="lg:col-span-2">
          <section className="mb-8 sm:mb-12">
            ...
            <Card variant="elevated" elevation={2} style={{ padding: "1.5rem" }} className="sm:p-8">
              ...
              <Stepper steps={steps} activeStep={activeStep} orientation="vertical" onStepClick={setActiveStep} />
            </Card>
          </section>
          ...
          <section className="mb-8 sm:mb-12">
            ...
            <div className="overflow-x-auto rounded-lg bg-gray-900 p-4 sm:p-6">
              <pre className="text-xs text-gray-100 sm:text-sm">
                <code>{`import { Stepper } from '@balanceui/core'
import { useState } from 'react'
